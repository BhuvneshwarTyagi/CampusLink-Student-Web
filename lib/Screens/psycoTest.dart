                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text('Question $count',style: TextStyle(fontSize:size.width*0.012,fontWeight:FontWeight.w600,color: Colors.white70),),
                            Text('/${snapshot.data()!["Questions"].length}',style: TextStyle(fontSize:size.width*0.012,fontWeight:FontWeight.w600,color: Colors.white60),),
                          ],
                        ),
                      ),
                      SizedBox(height: size.height*0.02,),
                      ...
                      //         child: SizedBox(
                      //           width: (size.width*0.34-(size.width*0.01*(snapshot.data()!["Questions"].length-1)))/snapshot.data()!["Questions"].length,
                      //
                      //           child: Divider(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder:(context, index) {
                                        return Padding(
                                          padding:  EdgeInsets.symmetric(vertical: size.height*0.008,horizontal: size.width*0.02),
                                          child: Container(
                  ...
                  children:[
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        fixedSize: Size(size.width*0.16,size.height*0.045),
                        shape: RoundedRectangleBorder(
                      ...
                      child:Row(
                        children: [
                          ...
                          Text("Previous",style: GoogleFonts.exo(fontSize: size.width*0.015,color: Colors.white),),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child:Text("Submit",style: GoogleFonts.exo(fontSize: size.width*0.015,color: Colors.black),),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child:Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            Text("Next",style: GoogleFonts.exo(fontSize: size.width*0.015,color: Colors.black),),
